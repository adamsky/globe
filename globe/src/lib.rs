...
impl Globe {
    pub fn render_on(&self, canvas: &mut Canvas) {
        ...
        let texture_width = (self.texture[0].len() - 1) as f32;
        let texture_height = (self.texture.len() - 1) as f32;
        ...
        for yi in 0..size_y {
            ...
            for xi in 0..size_x {
                ...
                theta -= theta.floor();
                let earth_x: usize = (theta * texture_width) as usize;
                let earth_y: usize = (phi * texture_height) as usize;
